/**
 * Lab 5 - Mini-Chatbot Complet
 * Objectif : Ajouter interactivité + structure + mémoire + gestion d'erreurs + température dynamique
 */
...
const CONFIG = {
  maxHistoryLength: 10,  // Nombre max de messages dans l'historique
...
let currentTemperature = CONFIG.defaultTemperature;
let messageCount = 0;

/**
 * Chatbot avec mémoire et gestion avancée
 */
class ChatBot {
  constructor() {
...
async function main() {
  ...
  rl.on('line', async (input) => {
    ...
    // Message normal - envoyer au chatbot
